...
def main(scenes):
    ...
    inputFolder = r"/projectnb/trenders/hook_utils/usearea/wrs_alb_vor_poly"
    outputFolder = r"/projectnb/trenders/scenes/gnn_snapped_cmon_usearea_files"
    ...
    for original_scene in scenes:
        ...
        print "New mask file created for {0} at {1}".format(scene, outputFolder + "/" + raster)
